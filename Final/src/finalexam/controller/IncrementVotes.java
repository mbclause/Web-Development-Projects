...
/**
 * Servlet implementation class IncrementVotes
 */
@WebServlet("/IncrementVotes")
public class IncrementVotes extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
				...
				stmt.executeUpdate("update books set num_votes = num_votes + 1 where id = '"+ id +"';");
		}
